  ...
  return (
    <section>
      <div className="container py-5">
        <h1 className="display-4 fw-bold display-color" >Sign In</h1>
        <p className="fs-4">
          <FaUser /> Sign Into Your Account
        </p>
        <Form onSubmit={handleLogin} className="d-grid gap-3 w-50">
          <Form.Control
            value={email}
            type="email"
          ...
          />
          <button type="submit" disabled={loading} className=" rounded-1">
